...
const MainTab = ({...props}) => {
    return(
        <>
            <div id={styles["outer"]} className={"main-tab"} style={props.style}>
                <div id={styles['hplogo-frame']}>
                    <img src={googleLogo} alt={"Google"} id={styles["hplogo"]}/>
                </div>
                <div id={styles["main"]}>
                    ...
                    <div id={styles["belowsb"]}>
                        <div className={styles.yKiQp} id={styles["gws-output-pages-elements-homepage_additional_languages__als"]}>
                            <div id={styles["SIvCob"]}>
                                Google offered in:
                                <a href="https://www.google.com/">Hungarian</a>
                            </div>
                        </div>
                    </div>
                </div>
